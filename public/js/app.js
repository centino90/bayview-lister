...
var tbldate = document.querySelector('.table-date');

var fetchOnDateChange = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(e) {
    var spinner, val, data, res, table, ctbody, tbody, caption, captTop, cc;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            spinner = document.querySelector('.table-spinner');
            spinner.classList.remove('hidden');
            val = e.target.value;
            console.log(val);
            _context.next = 6;
            return fetch("/tableSearchByDate?d=".concat(val), {
              method: "GET"
            });
          ...
          case 9:
            ...
            table = document.querySelector('.certification-table');
            ctbody = document.createElement('tbody');
            table.appendChild(ctbody);
            tbody = table.querySelector('tbody');
            caption = table.querySelector('.caption-btm');
            captTop = table.querySelector('.caption-top');
            cc = captTop.querySelectorAll('.counter span');
            console.log(res);
            ...
            if (res[0].length < 1) {
              ...
              cc[1].textContent = res[1][0].sess_pm;
              cc[2].textContent = res[1][0].count;
              res[0].forEach(function (re) {
                tbody.innerHTML += "\n                                <tr class=\"hover:bg-blue-100 border-t-2 border-solid border-blue-100\">\n                                    <td class=\"hover:bg-blue-400 hover:text-white pl-3 py-3 capitalize\">".concat(re.FullName, "</td> \n                                    <td class=\"py-3 hover:bg-blue-400 hover:text-white capitalize\">").concat(re.issue, "</td> \n                                    <td class=\"py-3 hover:bg-blue-400 hover:text-white capitalize\">").concat(re.category, "</td>\n                                    <td class=\"py-3 hover:bg-blue-400 hover:text-white capitalize\">").concat(re.purpose, "</td> \n                                    <td class=\"py-3 hover:bg-blue-400 hover:text-white capitalize\">").concat(re.issue_date, "</td> \n                                    <td class=\"py-3 hover:bg-blue-400 hover:text-white capitalize pr-3\">").concat(re.session, "</td>\n                                </tr>\n                            ");
              });
            }
  ...
  return function fetchOnDateChange(_x) {
...
var fetchOnInput = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(e) {
    var val, searchOut, data, res, head, lis, viewBtn, delBtn;
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 12:
            ...
            res.forEach(function (val) {
              ...
              hid.innerHTML = "   <span class=\"id\">".concat(val.id, "</span>\n                        <span class=\"fullname\">").concat(val.FullName, "</span>\n                        <span class=\"fname\">").concat(val.fname, "</span>\n                        <span class=\"mname\">").concat(val.mname, "</span>\n                        <span class=\"lname\">").concat(val.lname, "</span>\n                        <span class=\"issue\">").concat(val.issue, "</span>\n                        <span class=\"category\">").concat(val.category, "</span>\n                        <span class=\"purpose\">").concat(val.purpose, "</span>\n                        <span class=\"issue_date\">").concat(val.issue_date, "</span>\n                        <span class=\"session\">").concat(val.session, "</span>\n                        ");
            ...
            delBtn = document.querySelectorAll('.delete-more button');
  ...
  return function fetchOnInput(_x2) {
...
var promptPassword = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee3(e) {
    var prompt, uid, passwordSearch, res;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            prompt = window.prompt('Enter your confirmation password', '');
            uid = document.querySelector('meta[name="user-id"]').getAttribute('content');
          ...
          case 6:
            _context3.next = 8;
            return fetch("/confirmPassword?pwd=".concat(prompt, "&uid=").concat(uid), {
              method: "GET"
            });

          case 8:
            passwordSearch = _context3.sent;
            _context3.next = 11;
            return passwordSearch.json();
  ...
  return function promptPassword(_x3) {
...
var viewMore = function viewMore(e) {
  ...
  var fdetails = hid.querySelectorAll('.id, .fullname, .fname, .mname, .lname, .issue, .category, .purpose, .issue_date, .session');
  var xmname = '';

  if (hid.querySelector('.mname').textContent != 'null' && hid.querySelector('.mname').textContent != '') {
    xmname = "".concat(hid.querySelector('.mname').textContent, ".");
  }
  ...
  console.log(fd[6]);
  console.log(fd[9]);
  mBody.querySelector(".modal-issue option[value=".concat(fd[5], "]")).selected = true; //select category option based on db data

  mBody.querySelector(".modal-category option[value=".concat(fd[6], "]")).selected = true; //select category option based on db data

  mBody.querySelector(".modal-session option[value=".concat(fd[9], "]")).selected = true; //select category option based on db data
  ...
  var editBtn = document.querySelector('.edit-modal');
  editBtn.addEventListener('click', function (e) {
    var modalForm = document.querySelector('.modal-form');
    var submitBtn = document.querySelector('.submit');
    var inputs = mBody.querySelectorAll('div input, div textarea, div select');
    var txtarea = document.querySelector('.modal-form .txtarea');
    ...
    var labels = mBody.querySelectorAll('.modal-label');
    var inputP = mBody.querySelectorAll('.modal-p-inputs');
    inputs.forEach(function (inp) {
      if (inp.classList.contains('lname') && inp.hasAttribute('hidden')) {
        inp.removeAttribute('hidden');
        var mname = mBody.querySelector('.mname');
        var lname = mBody.querySelector('.lname');
        var fname = mBody.querySelector('.fname');
        var wrds = fname.value.split(" ");
        var count = 0;
        var lastind;
        ...
        for (var i = 0; i < wrds.length; i++) {
          if (wrds[i].length == 2 && wrds[i].includes('.') || wrds[i].length == 0 && wrds[i] == '') {
            ...
            fname.value += "".concat(wrds[i], " ");
            count++;
          } else if (lastind !== undefined && wrds[i] != lastind) {// lname.value += `${wrds[i]} `
          }
        }
      } else {
        inp.removeAttribute('hidden');
      ...
      inputP.forEach(function (el) {
        return el.classList.toggle('cursor-not-allowed');
      });
    });
  });
};
...
var unfocusSearchDiv = function unfocusSearchDiv(e) {
  e.stopPropagation();
  var parentDiv = e.target.parentNode.parentNode;
...
var upCaseLetterOfEachWord = function upCaseLetterOfEachWord(arr) {
  ...
  for (var i = 0; i < arr.length; i++) {
    if (arr[i].textContent == 'null' && !arr[i].classList.contains('mname')) arr[i].textContent = 'N/A';else if (arr[i].textContent == 'null' && arr[i].classList.contains('mname')) arr[i].textContent = '';
    var words = arr[i].textContent.split(" "); // for (let j = 0; j < words.length; j++) {
...
var furtherConfirmDelete = function furtherConfirmDelete(form) {
  var conf = confirm('Are you sure');
  if (conf) form.submit();else return false;
};
